...
<section id="summary">
	...
	<section>
		<h1>開催日時</h1>
		<p>${this.params.period && lit__WEBPACK_IMPORTED_MODULE_0__.html`
...
• 第2章　マーケットが出来るまで　ワールド制作の流れやコンセプトといったノウハウを記録！" />
	...
	${!this.beforeStarting && this.params.pamphletURL ? lit__WEBPACK_IMPORTED_MODULE_0__.html`<p><a rel="external" target="_blank"
...
<section id="exhibit">
	...
	<section id="room-managers">
		...
		<table>
			...
			<tbody>
				${this.staff && this.staff.filter(member => member.roles.includes('ルームマネージャー')).map(member => lit__WEBPACK_IMPORTED_MODULE_0__.html`<tr>
	...
	<section>
		<h1>締め切り</h1>
		<dl>${this.params.applicationDeadline && lit__WEBPACK_IMPORTED_MODULE_0__.html`
			<dt>出展申し込み</dt>
	...
	<section id="staff">
		...
		<address>
			<table class="table">
				...
				<tbody>${this.staff && this.staff.map(member => lit__WEBPACK_IMPORTED_MODULE_0__.html`<tr>
					<td><img src="images/${member.icon}" /></td>
					<td><ul>${member.roles.map(role => lit__WEBPACK_IMPORTED_MODULE_0__.html`<li>${role}</li>`)}</ul></td>
...
customElements.define('item-list', class extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
	...
	render()
	{
		return [
			[ 'simple', 'シンプル会場', null ],
			[ 'theme1', 'テーマ会場', '1. ${this.params.theme1}' ],
			[ 'theme2', 'テーマ会場', '2. ${this.params.theme2}' ],
